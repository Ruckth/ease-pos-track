...
const th: Record<keyof typeof en, string> = {
  ...
  stepMediaHint: "เพิ่มรูปหรือวิดีโออย่างน้อย 1 ไฟล์ แล้วจุดตำแหน่งที่มีปัญหา",
...
const errorKeys: Record<string, Key> = {
  ...
  UPLOAD_INCOMPLETE: "uploadIntentInvalid",
