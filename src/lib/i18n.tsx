...
const en = {
  ticketTags: "Tags",
  noTicketTags: "No tags",
  tagName: "Tag name",
  tagColor: "Tag color",
  createTag: "Create tag",
  tagCreated: "Tag created. Select it to add it to this Ticket.",
  tagsUpdated: "Tags updated",
  actionTagsChanged: "changed tags",
  invalidTagName: "Use a tag name of 1–32 characters without control characters.",
  tagAlreadyExists: "A tag with this name already exists.",
  tagNotFound: "This tag is no longer available. Refresh and try again.",
  tooManyTags: "A Ticket can have up to 20 tags.",
  tagSlate: "Slate",
  tagRed: "Red",
  tagOrange: "Orange",
  tagGreen: "Green",
  ...
  viewTicketMedia: "View {{count}} attachments for {{ticket}}",
...
const th: Record<keyof typeof en, string> = {
  ticketTags: "แท็ก",
  noTicketTags: "ไม่มีแท็ก",
  tagName: "ชื่อแท็ก",
  tagColor: "สีแท็ก",
  createTag: "สร้างแท็ก",
  tagCreated: "สร้างแท็กแล้ว เลือกแท็กเพื่อเพิ่มใน Ticket นี้",
  tagsUpdated: "อัปเดตแท็กแล้ว",
  actionTagsChanged: "เปลี่ยนแท็ก",
  invalidTagName: "ใช้ชื่อแท็ก 1–32 ตัวอักษร โดยไม่มีอักขระควบคุม",
  tagAlreadyExists: "มีแท็กชื่อนี้อยู่แล้ว",
  tagNotFound: "ไม่พบแท็กนี้ กรุณารีเฟรชแล้วลองอีกครั้ง",
  tooManyTags: "Ticket มีแท็กได้สูงสุด 20 แท็ก",
  tagSlate: "เทา",
  tagRed: "แดง",
  tagOrange: "ส้ม",
  tagGreen: "เขียว",
  ...
  viewTicketMedia: "ดูไฟล์แนบ {{count}} ไฟล์ของ {{ticket}}",
