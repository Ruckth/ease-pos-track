...
const en = {
  ...
  topic: "Topic", description: "Description", media: "Media", submit: "Submit", submitting: "Submitting…", cancel: "Cancel",
  ...
  requiredFeedback: "Topic, description, and at least one photo or video are required.", imageVideoOnly: "Only images and videos are supported.",
...
const th: Record<keyof typeof en, string> = {
  ...
  topic: "หัวข้อ", description: "รายละเอียด", media: "รูปหรือวิดีโอ", submit: "ส่งเรื่อง", submitting: "กำลังส่ง…", cancel: "ยกเลิก",
  ...
  requiredFeedback: "กรอกหัวข้อ รายละเอียด และเพิ่มรูปหรือวิดีโออย่างน้อย 1 ไฟล์", imageVideoOnly: "รองรับเฉพาะรูปและวิดีโอ",
