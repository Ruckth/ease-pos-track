  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          "group/step flex items-center justify-center [&:not(:last-child)]:flex-1 group-data-[orientation=horizontal]/stepper-nav:flex-row group-data-[orientation=vertical]/stepper-nav:flex-col",
          className
        )}
        data-state={state}
...
function StepperTrigger({
  ...
  const defaultProps = {
    ...
    className: cn(
      "focus-visible:border-ring focus-visible:ring-ring/50 inline-flex cursor-pointer items-center outline-none focus-visible:z-10 focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-60",
...
function StepperContent({
  ...
  return (
    <div
      ...
      data-state={activeStep}
      // Matches the `aria-controls`/`id` pair StepperTrigger advertises; without
      // these the trigger's aria-controls points at nothing and the panel is not
      // announced as the tab's content.
